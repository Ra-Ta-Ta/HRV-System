...
// Five_minute_hr.sync({ force: true })
// One_hour_hr.sync({ force: true })
// One_day_hr.sync({ force: true })
// One_week_hr.sync({ force: true })
// One_month_hr.sync({ force: true })

// Five_minute_hrv.sync({ force: true })
// One_hour_hrv.sync({ force: true })
// One_day_hrv.sync({ force: true })
// One_week_hrv.sync({ force: true })
